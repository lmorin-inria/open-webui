...
<a class=" flex space-x-4 cursor-pointer w-full mb-2 px-3 py-2" href="{WEBUI_BASE_PATH}/workspace/modelfiles/create">
		...
		>
			...
			<div class="flex flex-row space-x-1 self-center">
				<a
					...
					type="button"
					href={WEBUI_BASE_PATH+`/workspace/modelfiles/edit?tag=${encodeURIComponent(modelfile.tagName)}`}
				>
					<svg
				...
				<button
					...
					on:click={() => {
						...
						goto(WEBUI_BASE_PATH+'/workspace/modelfiles/create');
					}}
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
